...
function Video({ title, channel = "ABC", views, time, verified }) {
    ...
    return (
        <>
            <div className='container'>
                <div className='pic'>
                    <img src="https://picsum.photos/id/2/160/90" width={140} height={150} alt="Image Loading" />
                </div>
...
Video.propTypes = {
   ...
   // bgColor: PropTypes.string.isRequired,
    ...
    verified: PropTypes.symbol.isRequired
